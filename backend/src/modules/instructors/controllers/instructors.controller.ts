import { Controller, Get, Patch, Body, Query, Req, UseGuards, UseInterceptors, UploadedFile } from '@nestjs/common';
...
export class InstructorsController {
  ...
  @Get('me/courses')
  getMyCourses(@Req() req: any) { return this.instructorsService.getMyCourses(req.user); }
  ...
  @Get('me/profile')
  getProfile(@Req() req: any) { return this.instructorsService.getProfile(req.user); }
