          ...
          <div className="flex flex-col gap-3 lg:flex-row">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <select
                ...
                onChange={(event) =>
                  setReplyStatusFilter(
                    event.target.value as "unreplied" | "replied" | "all",
                  )
                }
        ...
        <div className="overflow-hidden rounded-md border border-slate-200 bg-white shadow-sm">
          <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50/50 px-6 py-4">
            <h2 className="text-[14px] font-bold text-slate-800">
              Hiển thị {filteredDiscussions.length.toLocaleString("vi-VN")} cuộc
              thảo luận
            </h2>
              ...
              <div className="divide-y divide-slate-100">
                {currentDiscussions.map((discussion) => {
                  ...
                  const areRepliesVisible =
                    expandedReplies[discussion.discussionId] ?? false;
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          {hasReplies && (
                            <button
                              type="button"
                              onClick={() =>
                                toggleReplies(discussion.discussionId)
                              }
                          ...
                          <div className="mt-4">
                            <button
                              type="button"
                              onClick={() =>
                                handleStartReply(discussion.discussionId)
                              }
                            ...
                            {(discussion.reportCount ?? 0) > 0 && (
                              <button
                                type="button"
                                onClick={() =>
                                  handleRejectReport(discussion.discussionId)
                                }
                            ...
                            <div className="mt-3 rounded border border-slate-200 bg-slate-50 p-4">
                              ...
                              <div className="mt-3 flex items-center justify-end gap-2">
                                ...
                                <button
                                  type="button"
                                  onClick={() =>
                                    void handleSubmitReply(discussion)
                                  }
                                  disabled={
