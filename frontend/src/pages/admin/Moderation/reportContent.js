...
function removeLeadingDuplicate(source, prefix) {
...
export function formatReportContent(raw) {
  ...
  if (parsed && typeof parsed === "object" && !Array.isArray(parsed)) {
    const title = stripHtml(parsed.title) || DEFAULT_CONTENT_TITLE;
    const lessonName = stripHtml(parsed.lessonName);
