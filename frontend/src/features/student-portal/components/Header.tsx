                    ...
                    <li className="list-inline-item">
                      <Dropdown>
                        <Dropdown.Toggle as="a">
                          ...
                          Tiếng Việt<i className="las la-angle-down"></i>
                        </Dropdown.Toggle>
                        <Dropdown.Menu as="ul">
                          <Dropdown.Item as="li">
                            <img src={"/assets/images/us.png"} alt="" /> Tiếng
                            Việt
                          </Dropdown.Item>
                          <Dropdown.Item as="li">
                    ...
                    <ul className="nav menu-nav">
                      <li className="nav-item active">
                        ...
                        <ul className="dropdown list-unstyled d-none">
                          ...
                          <li className="nav-item">
                            <Link className="nav-link" to={"/home-two"}>
                              Home Style 2
                            </Link>
                          </li>
                        </ul>
                      ...
                      <li className="nav-item dropdown">
                        <Link
                          ...
                          data-toggle="dropdown"
                        >
                          Bài viết <i className="las la-angle-down"></i>
                        </Link>
                        <ul className="dropdown list-unstyled">
                          <li className="nav-item">
                            <Link className="nav-link" to={"/blog-classic"}>
                              Blog Classic
                            </Link>
                          </li>
                          <li className="nav-item">
