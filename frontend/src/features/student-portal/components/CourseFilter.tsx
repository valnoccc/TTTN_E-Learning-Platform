...
function CourseFilter() {
    useEffect(() => {
        const buttonList = document.querySelector(".filter-btn-list");
        const itemList = document.querySelector(".filter-items");

        if (!buttonList || !itemList) {
            return;
        }

        const buttons = Array.from(buttonList.children) as HTMLElement[];
        const items = Array.from(itemList.children) as HTMLElement[];
